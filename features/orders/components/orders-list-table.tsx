 ...
 * Data table for displaying admin orders with sorting, filtering, and actions
 * Based on shadcn data-table-demo
 */
...
export function OrdersListTable({
  ...
  onView,
  onUpdateStatus,
}: OrdersListTableProps): React.ReactElement {
    ...
    <div className="space-y-4">
      ...
      <div className="flex items-center justify-end space-x-2">
        <div className="text-muted-foreground flex-1 text-sm">
          Showing {table.getRowModel().rows.length} of {orders.length} order(s)
        </div>
